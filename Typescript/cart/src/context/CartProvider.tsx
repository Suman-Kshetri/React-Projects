...
const useCartContext = (initCartState: CartStateType) => {
    ...
    //we memoized the reducer action type
...
const intiCartContextState: UseCartContextType = {
    dispatch: () => {},
...
export const CartContext = createContext<UseCartContextType>(intiCartContextState)
